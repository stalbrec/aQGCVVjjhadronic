...
def RooFitHist(inputhist,title='title',path='.'):
   ...
   meanstart=hist.GetBinCenter(hist.GetMaximumBin())#______________???????
...
if(__name__=="__main__"):
   ...
   f = TFile("/nfs/dust/cms/user/loemkerj/bachelor/CMSSW_10_2_16/src/UHH2/aQGCVVjjhadronic/SignalRegion/backup/uhh2.AnalysisModuleRunner.MC.MC_aQGC_ZZjj_hadronic_2016v3.root")
