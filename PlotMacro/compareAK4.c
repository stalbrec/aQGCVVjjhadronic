...
TH2D * h_pT_vs;
signal_region->GetObject("Kin_AK4_N_cut/pT_AK4_1_vs_pT_AK4_2_S2_5p0", h_pT_vs);//add ending for parameter
//pT4_vs -> SetLogy();
...
TH2D * h_eta_vs;
signal_region->GetObject("Kin_AK4_N_cut/eta_AK4_1_vs_eta_AK4_2_S2_5p0", h_eta_vs);//add ending for parameter
//eta4_vs -> SetLogy();
