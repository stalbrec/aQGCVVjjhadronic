...
namespace uhh2examples {
	...
	//After invariant Mass AK4 Cut 1.5TeV
	h_invMAk4sel_1p5.reset(new aQGCVVjjhadronicHists(ctx,"invMAk4sel_1p5_allcuts"));


	h_MjjHistsinvMAk4sel_1p5_WPWP.reset(new aQGCVVjjhadronicMjjHists(ctx,"MjjHists_invMAk4sel_1p5_allcuts_WPWP"));
	h_MjjHistsinvMAk4sel_1p5_WPWM.reset(new aQGCVVjjhadronicMjjHists(ctx,"MjjHists_invMAk4sel_1p5_allcuts_WPWM"));
	h_MjjHistsinvMAk4sel_1p5_WMWM.reset(new aQGCVVjjhadronicMjjHists(ctx,"MjjHists_invMAk4sel_1p5_allcuts_WMWM"));
	h_MjjHistsinvMAk4sel_1p5_WPZ.reset(new aQGCVVjjhadronicMjjHists(ctx,"MjjHists_invMAk4sel_1p5_allcuts_WPZ"));
	h_MjjHistsinvMAk4sel_1p5_WMZ.reset(new aQGCVVjjhadronicMjjHists(ctx,"MjjHists_invMAk4sel_1p5_allcuts_WMZ"));
	h_MjjHistsinvMAk4sel_1p5_ZZ.reset(new aQGCVVjjhadronicMjjHists(ctx,"MjjHists_invMAk4sel_1p5_allcuts_ZZ"));


	h_AK8jets_invMAk4sel_1p5.reset(new TopJetHists(ctx,"AK8_invMAk4sel_1p5_allcuts"));
	h_AK4jets_invMAk4sel_1p5.reset(new JetHists(ctx,"AK4_invMAk4sel_1p5_allcuts"));
   
	h_ele_invMAk4sel_1p5.reset(new ElectronHists(ctx,"electron_invMAk4sel_1p5_allcuts"));
	h_muon_invMAk4sel_1p5.reset(new MuonHists(ctx,"muon_invMAk4sel_1p5_allcuts"));

	/*h_genAK8jets_detaAk4sel;
	  h_genAK4jets_detaAk4sel;
	  h_gendijets_detaAk4sel;*/
	if(version_=="MC_aQGC_WPWPjj_hadronic_newrange_genplots"){
	    h_genparticle_invMAk4sel_1p5.reset(new aQGCVVjjhadronicGenHists(ctx,"genpart_invMAk4sel_1p5_allcuts"));
	}

	//After invarian Mass AK4 Cut 2TeV	
	h_invMAk4sel_2p0.reset(new aQGCVVjjhadronicHists(ctx,"invMAk4sel_2p0_allcuts"));


	h_MjjHistsinvMAk4sel_2p0_WPWP.reset(new aQGCVVjjhadronicMjjHists(ctx,"MjjHists_invMAk4sel_2p0_allcuts_WPWP"));
	h_MjjHistsinvMAk4sel_2p0_WPWM.reset(new aQGCVVjjhadronicMjjHists(ctx,"MjjHists_invMAk4sel_2p0_allcuts_WPWM"));
	h_MjjHistsinvMAk4sel_2p0_WMWM.reset(new aQGCVVjjhadronicMjjHists(ctx,"MjjHists_invMAk4sel_2p0_allcuts_WMWM"));
	h_MjjHistsinvMAk4sel_2p0_WPZ.reset(new aQGCVVjjhadronicMjjHists(ctx,"MjjHists_invMAk4sel_2p0_allcuts_WPZ"));
	h_MjjHistsinvMAk4sel_2p0_WMZ.reset(new aQGCVVjjhadronicMjjHists(ctx,"MjjHists_invMAk4sel_2p0_allcuts_WMZ"));
	h_MjjHistsinvMAk4sel_2p0_ZZ.reset(new aQGCVVjjhadronicMjjHists(ctx,"MjjHists_invMAk4sel_2p0_allcuts_ZZ"));


	h_AK8jets_invMAk4sel_2p0.reset(new TopJetHists(ctx,"AK8_invMAk4sel_2p0_allcuts"));
	h_AK4jets_invMAk4sel_2p0.reset(new JetHists(ctx,"AK4_invMAk4sel_2p0_allcuts"));
   
	h_ele_invMAk4sel_2p0.reset(new ElectronHists(ctx,"electron_invMAk4sel_2p0_allcuts"));
	h_muon_invMAk4sel_2p0.reset(new MuonHists(ctx,"muon_invMAk4sel_2p0_allcuts"));

	/*h_genAK8jets_detaAk4sel;
	  h_genAK4jets_detaAk4sel;
	  h_gendijets_detaAk4sel;*/
	if(version_=="MC_aQGC_WPWPjj_hadronic_newrange_genplots"){
	    h_genparticle_invMAk4sel_2p0.reset(new aQGCVVjjhadronicGenHists(ctx,"genpart_invMAk4sel_2p0_allcuts"));
	}
